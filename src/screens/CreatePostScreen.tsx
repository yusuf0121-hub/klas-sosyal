        ...
        <form onSubmit={handleSubmit}>
          ...
          />
            ...
            <div className="mb-4 grid gap-2 rounded-xl bg-slate-50 p-3">
              <div className="flex gap-2"><input value={tenorQuery} onChange={(e) => setTenorQuery(e.target.value)} placeholder="Tenor’da GIF ara (demo)" className="min-w-0 flex-1 rounded-lg border border-slate-200 px-3 py-2 text-xs" /><button type="button" onClick={() => setTenorResults(['https://media.tenor.com/2roX3uxz_68AAAAC/cat-cute.gif', 'https://media.tenor.com/7Vq7yN7vQwUAAAAC/funny-dance.gif'])} className="rounded-lg bg-violet-600 px-3 py-2 text-xs font-semibold text-white">Ara</button></div>
